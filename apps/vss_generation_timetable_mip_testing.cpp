...
int main(int argc, char** argv) {
  ...
  bool fix_routes               = std::stoi(argv[4]) != 0;
  bool discretize_vss_positions = std::stoi(argv[5]) != 0;
  bool include_train_dynamics   = std::stoi(argv[6]) != 0;
  bool include_braking_curves   = std::stoi(argv[7]) != 0;
  bool use_pwl                  = std::stoi(argv[8]) != 0;
  bool use_schedule_cuts        = std::stoi(argv[9]) != 0;
