...
// Every option of this app is defined in apps/cli/options_mb_astar.hpp, so
// that the 'solve mb-astar' subcommand of rail_cli offers the very same
// settings and the two cannot drift apart.
...
int main(int argc, char** argv) {
  ...
  cda_rail::cli::log_mb_astar_settings(settings,
  ...
  auto const solution = solver.solve(
      cda_rail::cli::mb_astar_model_detail(settings),
      cda_rail::cli::mb_astar_solver_strategy(settings),
      cda_rail::cli::general_solution_settings(
          settings.exporting, instance_settings.working_directory),
